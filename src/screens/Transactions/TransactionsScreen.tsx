...
export function TransactionsScreen() {
  ...
  const sections = useMemo<TransactionSection[]>(() => TRANSACTION_SECTIONS, []);
      ...
      >
        ...
        >
          ...
          <View style={{ marginTop: moderateScale(26) }}>
            <BalanceCard label="Total Balance" value="$7,783.00" />
          </View>
        ...
        >
          {sections.map((section, sectionIndex) => (
            <View
              key={section.title}
              style={{ marginBottom: sectionIndex === sections.length - 1 ? 0 : moderateScale(26) }}
            >
              <Text
                style={{
                  fontSize: moderateScale(22),
